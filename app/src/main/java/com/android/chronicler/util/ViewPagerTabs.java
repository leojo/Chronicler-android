 ...
 * This class is entirely borrowed from de.schildbach's android wallet app. It allows for small
 * tabs that show which fragment the view pager is displaying without using the action bar (which is
 * too large for all the tabs of the character sheet)
 */
public class ViewPagerTabs extends View implements OnPageChangeListener {
    ...
    protected void onDraw(final Canvas canvas)
    {
        ...
        for (int i = 0; i < labels.size(); i++)
        {
            ...
            paint.setColor(i == pagePosition ? Color.WHITE : Color.LTGRAY);
